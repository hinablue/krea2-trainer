...
from krea2_trainer.dataset.image_video_dataset import (
    ARCHITECTURE_HUNYUAN_VIDEO,
    BaseDataset,
    ItemInfo,
    save_text_encoder_output_cache,
)
from krea2_trainer.hunyuan_model import text_encoder as text_encoder_module
from krea2_trainer.hunyuan_model.text_encoder import TextEncoder
...
def process_text_encoder_batches(
    ...
    for i, dataset in enumerate(datasets):
        ...
        for batch in tqdm(batches, desc=f"{desc} [{i}]", leave=False):
