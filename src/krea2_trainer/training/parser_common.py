...
def _add_optimizer_args(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        ...
        "or Advanced Optimizers aliases: AdamW_adv, Prodigy_adv, Adopt_adv, Lion_adv, Muon_adv, AdaMuon_adv, SignSGD_adv, SinkSGD_adv. "
        "Also, you can use any optimizer by specifying the full path to the class, like 'torch.optim.AdamW', 'bitsandbytes.optim.AdEMAMix8bit' or 'adv_optm.optim.AdamW_adv' etc. / ",
    )
    parser.add_argument(
        "--optimizer_args",
        type=str,
